# Components
URL: /docs/getting-started/components
Source: /vercel/path0/docs/content/docs/(guides)/getting-started/components.mdx
...
<img src="/imgs/user-button.png" alt="UserButton" className="mx-auto block rounded-lg" width={200} height={200} />
...
<img src="/imgs/sign-in.png" alt="SignIn" className="mx-auto block rounded-lg" width={350} height={350} />
